CLASS zrap620_cl_ce_products_sb8 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_product_range TYPE RANGE OF zrap620_sc_products_sb8=>tys_sepmra_i_product_etype.
    TYPES t_business_data TYPE zrap620_sc_products_sb8=>tyt_sepmra_i_product_etype.
    TYPES t_business_data_external TYPE TABLE OF ZRAP620_CE_PRODUCTS_SB8.
...
CLASS zrap620_cl_ce_products_sb8 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
   DATA business_data TYPE t_business_data."zrap620_sb8sepmra_i_product_e.
    ...
    odata_client_proxy = /iwbep/cl_cp_factory_remote=>create_v2_remote_proxy(
      EXPORTING
         is_proxy_model_key       = VALUE #( repository_id       = 'DEFAULT'
                                             proxy_model_id      = 'ZRAP620_SC_PRODUCTS_SB8'
